#!/usr/bin/env python3
"""Run the official unified Isaac Lab RSL-RL player with FinsSim tasks."""
...
def main() -> None:
    ...
    runner = isaaclab_path / "scripts" / "reinforcement_learning" / "play.py"
    if not runner.is_file():
        raise FileNotFoundError(f"Isaac Lab RSL-RL play script not found: {runner}")
    ...
    # See train.py: the unified dispatcher imports sibling common.py.
